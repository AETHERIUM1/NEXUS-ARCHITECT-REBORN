    ...
    <ViewContainer title="Architecture Matrix">
      <div className="flex flex-col items-center">
        ...
        <ArchBox title="NEXUS Core Logic" subtitle="TypeScript Services" className="w-full max-w-md">
            geminiService.ts, speechService.ts
        </ArchBox>
        ...
        <ArchBox title="Google Gemini API" subtitle="Cloud AI Layer" className="w-full max-w-md">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mt-2 text-xs">
                <span className="bg-slate-700 p-1 rounded">gemini-2.5-flash</span>
                <span className="bg-slate-700 p-1 rounded">imagen-3.0-generate</span>
                <span className="bg-slate-700 p-1 rounded">veo-2.0-generate</span>
            </div>
        </ArchBox>
